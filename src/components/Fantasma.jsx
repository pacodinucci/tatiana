    ...
    <>
        ...
        <section>
            <div className={styles.header}>
                <span><p className={styles.negrita}>Estoy acostumbrado a borrarme de las páginas,</p> para eso me pagan. Para vivir diferentes<br/> vidas en mi cabeza por un tiempo limitado y transcribirlas al papel. Luego, ellos o<br/> ellas las firman y yo <p className={styles.negrita}>desaparezco.</p> Son dueños del corte final, pueden sacar aquello<br/> con lo que no estén de acuerdo. Eso es lo que suele estar en los contratos, contratos<br/> larguísimos que siempre terminan con un anexo donde se firma el acuerdo de<br/> confidencialidad. Piedra angular de mi trabajo, la que me emparienta con sacerdotes,<br/> psiquiatras, psicólogos, abogados, periodistas. Un grupo de <p className={styles.negrita}>cuidadores de secretos</p><br/> que, con mayor o menor rigurosidad, tenemos almacenadas palabras que no podemos<br/> soltar.<br/> Nuestras situaciones son distintas: algunos pueden soltarlas si las vidas de los que<br/> las profirieron corren peligro; otros, si los que hablan representan una amenaza<br/> contra la sociedad. Lo mío es más borroso, <p className={styles.negrita}>no hay reglas universales del escritor<br/> fantasma,</p> no es una profesión registrada, no se enseña en las universidades, es una<br/> vocación. Es salirse de la página, extirparse del mundo. <p className={styles.negrita}>Somos los ausentes.</p></span>
